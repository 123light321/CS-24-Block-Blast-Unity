...
public class bl_RotationDynamic
{
    ...
    public void OnUpdate()
    {
        ...
        else
        {
            ...
            m_Transform.localRotation = Quaternion.Slerp(m_Transform.localRotation, Quaternion.Euler(CurrentPosition), (Time.deltaTime * BlockBlast.bl_Utils.MathfUtils.EaseLerp(Lerp)) * Time.timeScale);
