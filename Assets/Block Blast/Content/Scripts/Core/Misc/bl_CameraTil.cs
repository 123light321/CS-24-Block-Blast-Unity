...
public class bl_CameraTil : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        this.m_transform.localRotation = Quaternion.Lerp(this.m_transform.localRotation, Quaternion.Euler(0, 0, t_amount), Time.deltaTime * BlockBlast.bl_Utils.MathfUtils.EaseLerpExtreme(smooth));
    }
